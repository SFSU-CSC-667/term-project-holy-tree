...
templates['player_card'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div>\n<div class=\"imageSize\">\n<div class=\"player-card img-circle\" data-id='"
    ...
    + "\") center center no-repeat; background-size: cover;'>\n  <span><i class=\"material-icons md-48\"></i></span>\n</div>\n<div class=\"player-card-name\">"
...
templates['results_display'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <tr>\n            <td>"
    ...
    + "</td>\n            <td>"
    + alias4(((helper = (helper = helpers.vote || (depth0 != null ? depth0.vote : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"vote","hash":{},"data":data}) : helper)))
    + "</td>\n            <td>"
